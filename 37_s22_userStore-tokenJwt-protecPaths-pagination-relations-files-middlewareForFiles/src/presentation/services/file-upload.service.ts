...
export class FileUploadService {
    ...
    public async uploadMultiple(
        ...
        const fileNames = await Promise.all(                                        //Promise.all() : genera un arreglo de promesas y todas las ejecuta de manera simultanea, pero hasta q todas reponden, se van a obtener los archivos.
