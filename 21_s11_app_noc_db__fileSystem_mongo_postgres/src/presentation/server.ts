...
const fs_logRepository = new LogRepositoryImpl(new FileSystemDatasource());      //para usar filesystem

const mongo_logRepository = new LogRepositoryImpl(new MongoLogDatasource());            //para usar mongo

const postgres_logRepository = new LogRepositoryImpl(new PostgresLogDatasource());            //para usar postgre
        ...
        CronService.createJob2('*/5 * * * * *', 
            () => {
                ...
                new CheckServiceMultiple(
                    [fs_logRepository, mongo_logRepository, postgres_logRepository],
